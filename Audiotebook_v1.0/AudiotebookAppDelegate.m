...
#import "AudiotebookAppDelegate.h"
#import "Contact.h"
#import "AudiotebookViewController.h"

@implementation AudiotebookAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    AudiotebookViewController *rootView = (AudiotebookViewController *)self.window.rootViewController;
    ...
    if ([prefs boolForKey:@"hasRunBefore"] != YES)
    {
        ...
        Contact *contact = (Contact *)[NSEntityDescription insertNewObjectForEntityForName:@"Contact" inManagedObjectContext:self.managedObjectContext];
        [contact setJob:@"Disco Dancer"];
        [contact setName:@"Robert Walport"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"PictureList.sqlite"];
